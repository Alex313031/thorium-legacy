...
//#endif // BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX)
    ...
    {"classic-omnibox",
     "Classic Omnibox UI",
     "Changes the omnibox shape to more closely match the classic M49 appearance.",
    ...
    {"transparent-tabs",
     ...
     "Reduces the opacity of tabs and the new tab button, as was the standard appearance before the Chromium 2018 UI refresh.",
     kOsDesktop, SINGLE_VALUE_TYPE("transparent-tabs")},
    {"override-tab-outline-default",
     "Override Trapezoidal Tabs Outline Default",
     "Trapezoidal tabs normally have outlines while rounded tabs do not. This option allows the user to override the default setting "
     "and disable outlines for the tab shape when trapezoidal tabs are enabled.",
     kOsDesktop, SINGLE_VALUE_TYPE("override-tab-outline-default")},
    {"override-new-tab-button-shape-default",
     "Override New Tab Button Shape Default",
     "Trapezoidal tabs used an angled trapzeoidal new tab button, while rounded tabs used a round one. This option allows the user to override the default setting "
     "for the new tab button when trapezoidal tabs are enabled.",
