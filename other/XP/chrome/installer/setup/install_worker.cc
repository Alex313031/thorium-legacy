...
void AddChromeWorkItems(const InstallParams& install_params,
  ...
  install_list->AddCopyTreeWorkItem(src_path.Append(kHKLM),
                                    ...
                                    temp_path, WorkItem::ALWAYS);
  install_list->AddCopyTreeWorkItem(src_path.Append(kREMO),
                                    target_path.Append(kREMO),
                                    temp_path, WorkItem::ALWAYS);
  ...
  install_list->AddCopyTreeWorkItem(src_path.Append(kInstallBat),
                                    ...
                                    temp_path, WorkItem::ALWAYS);
  install_list->AddCopyTreeWorkItem(src_path.Append(kRemoveBat),
                                    target_path.Append(kRemoveBat),
                                    temp_path, WorkItem::ALWAYS);
  // README file
